...
JSBool JSB_CCControl_ctor(JSContext *cx, uint32_t argc, jsval *vp) {

	JSObject* obj = (JSObject *)JS_THIS_OBJECT(cx, vp);
	JSB_PRECONDITION2( !JSB_get_proxy_for_jsobject(obj), cx, JS_FALSE, "Object already initialzied. error" );

	JSB_CCControl *proxy = [[JSB_CCControl alloc] initWithJSObject:obj class:[CCControl class]];
...
JSBool JSB_CCControl_color(JSContext *cx, uint32_t argc, jsval *vp) {
    ...
    JS_SET_RVAL(cx, vp, JSB_jsval_from_ccColor3B(cx, ret_val));
...
JSBool JSB_CCControl_setColor_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_ccColor3B( cx, *argvp++, &arg0 );
...
void JSB_CCControl_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getColor", JSB_CCControl_color, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getDefaultTouchPriority", JSB_CCControl_defaultTouchPriority, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("doesOpacityModifyRGB", JSB_CCControl_doesOpacityModifyRGB, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getHasVisibleParents", JSB_CCControl_hasVisibleParents, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isEnabled", JSB_CCControl_isEnabled, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isHighlighted", JSB_CCControl_isHighlighted, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isSelected", JSB_CCControl_isSelected, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("needsLayout", JSB_CCControl_needsLayout, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getOpacity", JSB_CCControl_opacity, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("openURL", JSB_CCControl_openURL_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setCallback", JSB_CCControl_setBlock_forControlEvents_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setColor", JSB_CCControl_setColor_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setDefaultTouchPriority", JSB_CCControl_setDefaultTouchPriority_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setEnabled", JSB_CCControl_setEnabled_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setHighlighted", JSB_CCControl_setHighlighted_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setOpacity", JSB_CCControl_setOpacity_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setOpacityModifyRGB", JSB_CCControl_setOpacityModifyRGB_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setSelected", JSB_CCControl_setSelected_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getState", JSB_CCControl_state, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ctor", JSB_CCControl_ctor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
...
// 'ctor' method. Needed for subclassing native objects in JS
JSBool JSB_CCScale9Sprite_ctor(JSContext *cx, uint32_t argc, jsval *vp) {

	JSObject* obj = (JSObject *)JS_THIS_OBJECT(cx, vp);
	JSB_PRECONDITION2( !JSB_get_proxy_for_jsobject(obj), cx, JS_FALSE, "Object already initialzied. error" );

	JSB_CCScale9Sprite *proxy = [[JSB_CCScale9Sprite alloc] initWithJSObject:obj class:[CCScale9Sprite class]];
	[[proxy class] swizzleMethods];
...
JSBool JSB_CCScale9Sprite_capInsets(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_CGRect(cx, ret_val));
...
JSBool JSB_CCScale9Sprite_initWithFile_capInsets_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_CGRect( cx, *argvp++, &arg1 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");

	CCScale9Sprite *real = [(CCScale9Sprite*)[proxy.klass alloc] initWithFile:(NSString*)arg0 capInsets:arg1  ];
...
// Arguments: NSString*, NSObject*, NSObject*
// Ret value: None (None)
JSBool JSB_CCScale9Sprite_initWithFile_rect_capInsets_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval *argvp = JS_ARGV(cx,vp);
	JSBool ok = JS_TRUE;
	NSString* arg0; CGRect arg1, arg2;
	...
	if (argc >= 3) {
		ok &= JSB_jsval_to_CGRect( cx, *argvp++, &arg2 );
	}
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
	...
	[proxy release];
		...
		CCScale9Sprite *real = [(CCScale9Sprite*)[proxy.klass alloc] initWithFile:(NSString*)arg0 rect:arg1  ];
	[proxy setRealObj: real];
	[real autorelease];
	...
	[proxy release];
		...
		CCScale9Sprite *real = [(CCScale9Sprite*)[proxy.klass alloc] initWithFile:(NSString*)arg0 rect:arg1 capInsets:arg2  ];
	[proxy setRealObj: real];
	[real autorelease];
...
JSBool JSB_CCScale9Sprite_initWithSpriteFrame_capInsets_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	[proxy release];
		...
		CCScale9Sprite *real = [(CCScale9Sprite*)[proxy.klass alloc] initWithSpriteFrame:arg0 capInsets:arg1  ];
	[proxy setRealObj: real];
	[real autorelease];
...
JSBool JSB_CCScale9Sprite_initWithSpriteFrameName_capInsets_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	[proxy release];
		...
		CCScale9Sprite *real = [(CCScale9Sprite*)[proxy.klass alloc] initWithSpriteFrameName:(NSString*)arg0 capInsets:arg1  ];
	[proxy setRealObj: real];
	[real autorelease];
...
JSBool JSB_CCScale9Sprite_originalSize(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_CGSize(cx, ret_val));
...
JSBool JSB_CCScale9Sprite_resizableSpriteWithCapInsets_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_CGRect( cx, *argvp++, &arg0 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
	CCScale9Sprite* ret_val;

	CCScale9Sprite *real = (CCScale9Sprite*) [proxy realObj];
	ret_val = [real resizableSpriteWithCapInsets:arg0  ];
...
JSBool JSB_CCScale9Sprite_setPreferedSize_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_CGSize( cx, *argvp++, &arg0 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");

	CCScale9Sprite *real = (CCScale9Sprite*) [proxy realObj];
	[real setPreferedSize:arg0  ];
...
JSBool JSB_CCScale9Sprite_spriteWithFile_capInsets__static(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ret_val = [CCScale9Sprite spriteWithFile:(NSString*)arg0 capInsets:arg1  ];
...
JSBool JSB_CCScale9Sprite_spriteWithFile_rect_capInsets__static(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if( argc == 1 ) {
		...
		ret_val = [CCScale9Sprite spriteWithFile:(NSString*)arg0 rect:arg1  ];
	}
	else if( argc == 3 ) {
		ret_val = [CCScale9Sprite spriteWithFile:(NSString*)arg0 rect:arg1 capInsets:arg2  ];
	}
	else
		JSB_PRECONDITION2(NO, cx, JS_FALSE, "Error in number of arguments");
...
JSBool JSB_CCScale9Sprite_spriteWithSpriteFrame_capInsets__static(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if( argc == 1 ) {
		...
		ret_val = [CCScale9Sprite spriteWithSpriteFrame:arg0 capInsets:arg1  ];
	}
	else
		JSB_PRECONDITION2(NO, cx, JS_FALSE, "Error in number of arguments");
...
JSBool JSB_CCScale9Sprite_spriteWithSpriteFrameName_capInsets__static(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if( argc == 1 ) {
		...
		ret_val = [CCScale9Sprite spriteWithSpriteFrameName:(NSString*)arg0 capInsets:arg1  ];
	}
	else
		JSB_PRECONDITION2(NO, cx, JS_FALSE, "Error in number of arguments");
...
void JSB_CCScale9Sprite_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getCapInsets", JSB_CCScale9Sprite_capInsets, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getColor", JSB_CCScale9Sprite_color, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("doesOpacityModifyRGB", JSB_CCScale9Sprite_doesOpacityModifyRGB, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("_initWithFile", JSB_CCScale9Sprite_initWithFile_capInsets_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initWithFile", JSB_CCScale9Sprite_initWithFile_rect_capInsets_, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initWithSpriteFrame", JSB_CCScale9Sprite_initWithSpriteFrame_capInsets_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initWithSpriteFrameName", JSB_CCScale9Sprite_initWithSpriteFrameName_capInsets_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getInsetBottom", JSB_CCScale9Sprite_insetBottom, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getInsetLeft", JSB_CCScale9Sprite_insetLeft, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getInsetRight", JSB_CCScale9Sprite_insetRight, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getInsetTop", JSB_CCScale9Sprite_insetTop, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getOpacity", JSB_CCScale9Sprite_opacity, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getOriginalSize", JSB_CCScale9Sprite_originalSize, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getPreferedSize", JSB_CCScale9Sprite_preferedSize, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getResizableSprite", JSB_CCScale9Sprite_resizableSpriteWithCapInsets_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setCapInsets", JSB_CCScale9Sprite_setCapInsets_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setColor", JSB_CCScale9Sprite_setColor_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setInsetBottom", JSB_CCScale9Sprite_setInsetBottom_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setInsetLeft", JSB_CCScale9Sprite_setInsetLeft_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setInsetRight", JSB_CCScale9Sprite_setInsetRight_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setInsetTop", JSB_CCScale9Sprite_setInsetTop_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setOpacity", JSB_CCScale9Sprite_setOpacity_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setOpacityModifyRGB", JSB_CCScale9Sprite_setOpacityModifyRGB_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setPreferedSize", JSB_CCScale9Sprite_setPreferedSize_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setSpriteFrame", JSB_CCScale9Sprite_setSpriteFrame_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ctor", JSB_CCScale9Sprite_ctor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FN("_create", JSB_CCScale9Sprite_spriteWithFile_capInsets__static, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("create", JSB_CCScale9Sprite_spriteWithFile_rect_capInsets__static, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("createWithSpriteFrame", JSB_CCScale9Sprite_spriteWithSpriteFrame_capInsets__static, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("createWithSpriteFrameName", JSB_CCScale9Sprite_spriteWithSpriteFrameName_capInsets__static, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
...
// 'ctor' method. Needed for subclassing native objects in JS
JSBool JSB_CCControlButton_ctor(JSContext *cx, uint32_t argc, jsval *vp) {

	JSObject* obj = (JSObject *)JS_THIS_OBJECT(cx, vp);
	JSB_PRECONDITION2( !JSB_get_proxy_for_jsobject(obj), cx, JS_FALSE, "Object already initialzied. error" );

	JSB_CCControlButton *proxy = [[JSB_CCControlButton alloc] initWithJSObject:obj class:[CCControlButton class]];
	[[proxy class] swizzleMethods];
...
// Arguments: NSObject*, CCScale9Sprite*
// Ret value: CCControlButton* (o)
...
JSBool JSB_CCControlButton_labelAnchorPoint(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	JS_SET_RVAL(cx, vp, JSB_jsval_from_CGPoint(cx, ret_val));
...
// Arguments: NSObject*, CCControlState
// Ret value: void (None)
...
JSBool JSB_CCControlButton_setLabelAnchorPoint_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ok &= JSB_jsval_to_CGPoint( cx, *argvp++, &arg0 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");

	CCControlButton *real = (CCControlButton*) [proxy realObj];
	[real setLabelAnchorPoint:arg0  ];
...
JSBool JSB_CCControlButton_setTitleColor_forState_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCControlButton *real = (CCControlButton*) [proxy realObj];
	[real setTitleColor:arg0 forState:(CCControlState)arg1  ];
...
void JSB_CCControlButton_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getBackgroundSprite", JSB_CCControlButton_backgroundSprite, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getBackgroundSpriteForState", JSB_CCControlButton_backgroundSpriteForState_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getCurrentTitle", JSB_CCControlButton_currentTitle, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getCurrentTitleColor", JSB_CCControlButton_currentTitleColor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("doesAdjustBackgroundImage", JSB_CCControlButton_doesAdjustBackgroundImage, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initWithBackgroundSprite", JSB_CCControlButton_initWithBackgroundSprite_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initWithLabelBackgroundSprite", JSB_CCControlButton_initWithLabel_backgroundSprite_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initWithTitleFontNameFontSize", JSB_CCControlButton_initWithTitle_fontName_fontSize_, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getLabelAnchorPoint", JSB_CCControlButton_labelAnchorPoint, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getPreferedSize", JSB_CCControlButton_preferedSize, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setAdjustBackgroundImage", JSB_CCControlButton_setAdjustBackgroundImage_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setBackgroundSprite", JSB_CCControlButton_setBackgroundSprite_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setBackgroundSpriteForState", JSB_CCControlButton_setBackgroundSprite_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setBackgroundSpriteFrameForState", JSB_CCControlButton_setBackgroundSpriteFrame_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setLabelAnchorPoint", JSB_CCControlButton_setLabelAnchorPoint_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setPreferedSize", JSB_CCControlButton_setPreferedSize_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setTitleForState", JSB_CCControlButton_setTitle_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setTitleBMFontForState", JSB_CCControlButton_setTitleBMFont_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setTitleColorForState", JSB_CCControlButton_setTitleColor_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setTitleLabelForState", JSB_CCControlButton_setTitleLabel_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setTitleTTFForState", JSB_CCControlButton_setTitleTTF_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setTitleTTFSizeForState", JSB_CCControlButton_setTitleTTFSize_forState_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setZoomOnTouchDown", JSB_CCControlButton_setZoomOnTouchDown_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getTitleColorForState", JSB_CCControlButton_titleColorForState_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getTitleForState", JSB_CCControlButton_titleForState_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getTitleLabelForState", JSB_CCControlButton_titleLabelForState_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getTitleTTFForState", JSB_CCControlButton_titleTTFForState_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getTitleTTFSizeForState", JSB_CCControlButton_titleTTFSizeForState_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getZoomOnTouchDown", JSB_CCControlButton_zoomOnTouchDown, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ctor", JSB_CCControlButton_ctor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FN("createWithSprite", JSB_CCControlButton_buttonWithBackgroundSprite__static, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("createWithLabel", JSB_CCControlButton_buttonWithLabel_backgroundSprite__static, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("createWithTitle", JSB_CCControlButton_buttonWithTitle_fontName_fontSize__static, 3, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
