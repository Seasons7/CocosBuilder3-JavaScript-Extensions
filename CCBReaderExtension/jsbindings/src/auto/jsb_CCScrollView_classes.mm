...
JSBool JSB_CCScrollView_ctor(JSContext *cx, uint32_t argc, jsval *vp) {

	JSObject* obj = (JSObject *)JS_THIS_OBJECT(cx, vp);
	JSB_PRECONDITION2( !JSB_get_proxy_for_jsobject(obj), cx, JS_FALSE, "Object already initialzied. error" );

	JSB_CCScrollView *proxy = [[JSB_CCScrollView alloc] initWithJSObject:obj class:[CCScrollView class]];
...
JSBool JSB_CCScrollView_initWithViewSize_container_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if( argc == 1 ) {
		CCScrollView *real = [(CCScrollView*)[proxy.klass alloc] initWithViewSize:arg0  ];
	...
	[proxy release];
		...
		CCScrollView *real = [(CCScrollView*)[proxy.klass alloc] initWithViewSize:arg0 container:arg1  ];
	[proxy setRealObj: real];
	[real autorelease];
...
JSBool JSB_CCScrollView_setContentOffset_animated_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if( argc == 1 ) {
		CCScrollView *real = (CCScrollView*) [proxy realObj];
	[real setContentOffset:arg0  ];
	}
	else if( argc == 2 ) {
		CCScrollView *real = (CCScrollView*) [proxy realObj];
	[real setContentOffset:arg0 animated:(BOOL)arg1  ];
	}
	else
		JSB_PRECONDITION2(NO, cx, JS_FALSE, "Error in number of arguments");
...
JSBool JSB_CCScrollView_setContentOffset_animatedInDuration_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	jsval *argvp = JS_ARGV(cx,vp);
	JSBool ok = JS_TRUE;
	CGPoint arg0; ccTime arg1;

	ok &= JSB_jsval_to_CGPoint( cx, *argvp++, &arg0 );
	ok &= JS_ValueToNumber( cx, *argvp++, (double *)&arg1 );
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");

	CCScrollView *real = (CCScrollView*) [proxy realObj];
	[real setContentOffset:arg0 animatedInDuration:arg1  ];
...
JSBool JSB_CCScrollView_setZoomScale_animatedInDuration_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCScrollView *real = (CCScrollView*) [proxy realObj];
	[real setZoomScale:(float)arg0 animatedInDuration:arg1  ];
...
JSBool JSB_CCScrollView_viewWithViewSize_container__static(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if( argc == 1 ) {
		ret_val = [CCScrollView viewWithViewSize:arg0  ];
	}
	else if( argc == 2 ) {
		ret_val = [CCScrollView viewWithViewSize:arg0 container:arg1  ];
	}
	else
		JSB_PRECONDITION2(NO, cx, JS_FALSE, "Error in number of arguments");
...
void JSB_CCScrollView_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		JS_FN("getBounces", JSB_CCScrollView_bounces, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getClipsToBounds", JSB_CCScrollView_clipsToBounds, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getContentOffset", JSB_CCScrollView_contentOffset, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getDirection", JSB_CCScrollView_direction, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("initWithViewSize", JSB_CCScrollView_initWithViewSize_container_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getIsDragging", JSB_CCScrollView_isDragging, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("isNodeVisible", JSB_CCScrollView_isNodeVisible_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("maxContainerOffset", JSB_CCScrollView_maxContainerOffset, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getMaxZoomScale", JSB_CCScrollView_maxZoomScale, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("minContainerOffset", JSB_CCScrollView_minContainerOffset, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getMinZoomScale", JSB_CCScrollView_minZoomScale, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("pause", JSB_CCScrollView_pause_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("resume", JSB_CCScrollView_resume_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setBounces", JSB_CCScrollView_setBounces_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setClipsToBounds", JSB_CCScrollView_setClipsToBounds_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setContentOffset", JSB_CCScrollView_setContentOffset_animated_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setContentOffsetInDuration", JSB_CCScrollView_setContentOffset_animatedInDuration_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setDirection", JSB_CCScrollView_setDirection_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setMaxZoomScale", JSB_CCScrollView_setMaxZoomScale_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setMinZoomScale", JSB_CCScrollView_setMinZoomScale_, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setZoomScale", JSB_CCScrollView_setZoomScale_animated_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("setZoomScaleInDuration", JSB_CCScrollView_setZoomScale_animatedInDuration_, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("getZoomScale", JSB_CCScrollView_zoomScale, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FN("ctor", JSB_CCScrollView_ctor, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
	static JSFunctionSpec st_funcs[] = {
		JS_FN("create", JSB_CCScrollView_viewWithViewSize_container__static, 2, JSPROP_PERMANENT | JSPROP_ENUMERATE),
		JS_FS_END
	};
