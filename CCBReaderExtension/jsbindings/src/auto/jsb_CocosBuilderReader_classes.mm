...
JSBool JSB_CCBAnimationManager_documentCallbackEvents(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCBAnimationManager *real = (CCBAnimationManager*) [proxy realObj];
	ret_val = [real documentCallbackEvents ];
...
JSBool JSB_CCBAnimationManager_setRootContainerSize_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCBAnimationManager *real = (CCBAnimationManager*) [proxy realObj];
	[real setRootContainerSize:arg0  ];
...
void JSB_CCBAnimationManager_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("getDocumentCallbackEvents", JSB_CCBAnimationManager_documentCallbackEvents, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
JSBool JSB_CCBReader_nodeGraphFromFile_owner_parentSize__static(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if (argc >= 3) {
		ok &= JSB_jsval_to_CGSize( cx, *argvp++, &arg2 );
	}
	JSB_PRECONDITION2(ok, cx, JS_FALSE, "Error processing arguments");
	CCNode* ret_val;
	...
	if( argc == 1 ) {
		...
		ret_val = [CCBReader nodeGraphFromFile:(NSString*)arg0 owner:arg1 parentSize:arg2  ];
	}
	else
...
JSBool JSB_CCBReader_nodeGraphFromFile_owner_parentSize_(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	ret_val = [real nodeGraphFromFile:(NSString*)arg0 owner:arg1  ];
		...
		CCBReader *real = (CCBReader*) [proxy realObj];
	ret_val = [real nodeGraphFromFile:(NSString*)arg0 owner:arg1 parentSize:arg2  ];
	}
	else
		JSB_PRECONDITION2(NO, cx, JS_FALSE, "Error in number of arguments");
...
// Arguments: 
// Ret value: NSMutableArray* (array)
JSBool JSB_CCBReader_ownerCallbackEvents(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	CCBReader *real = (CCBReader*) [proxy realObj];
	ret_val = [real ownerCallbackEvents ];
...
JSBool JSB_CCBReader_sceneWithNodeGraphFromFile_owner_parentSize__static(JSContext *cx, uint32_t argc, jsval *vp) {
	...
	if( argc == 1 ) {
		...
		ret_val = [CCBReader sceneWithNodeGraphFromFile:(NSString*)arg0 owner:arg1 parentSize:arg2  ];
	}
	else
		JSB_PRECONDITION2(NO, cx, JS_FALSE, "Error in number of arguments");
...
void JSB_CCBReader_createClass(JSContext *cx, JSObject* globalObj, const char* name )
{
	...
	static JSFunctionSpec funcs[] = {
		...
		JS_FN("getOwnerCallbackEvents", JSB_CCBReader_ownerCallbackEvents, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
